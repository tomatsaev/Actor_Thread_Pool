    ...
    public Output(HashMap<String, PrivateState> actorsState) {
        for (String key : actorsState.keySet()) {
            ...
            if (state instanceof CoursePrivateState) {
                ...
                courses.add(new Course(key, courseState.getLogger(), Integer.toString(courseState.getAvailableSpots()), Integer.toString(courseState.getRegistered()), courseState.getRegStudents(), courseState.getPrerequisites()));
            }
